...
1. **Extract** the archive to a folder (e.g., `C:\CiRA-FES-v1.0\`)
2. **Launch Pipeline Builder**: Double-click `Launch_Pipeline_Builder.bat`
...
**Important**: Always use the launcher scripts (`Launch_Pipeline_Builder.bat` or `Launch_CiRA_Studio.bat`) instead of running executables directly from the `bin/` folder.
